...
// Постоянная ссылка на MTProto-proxy self-сервера (см. MtProxyService на бэкенде) — одна
// на всех клиентов, устанавливается администратором заранее (кнопка на карточке
// self-сервера в «Серверах»), ключ меняется автоматически раз в сутки.
